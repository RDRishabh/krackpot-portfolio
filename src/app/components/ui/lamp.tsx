...
export function LampDemo() {
  return (
    <LampContainer>
      ...
      >
        Build Technology <br /> the right way
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-400 items-center justify-center isolate z-0 top-12">
        <motion.div
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 top-10 lg:top-8">
        {children}
      </div>
    </div>
  );
